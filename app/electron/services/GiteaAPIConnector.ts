...
import {addAuthenticationTokenInterceptor, errorResponseInterceptor, successResponseInterceptor} from "./Interceptors";
...
export class GiteaAPIConnector {
    ...
    constructor() {
        ...
        this.apiClient.interceptors.response.use(successResponseInterceptor, errorResponseInterceptor);
    }
